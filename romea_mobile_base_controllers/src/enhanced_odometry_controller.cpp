...
//-----------------------------------------------------------------------------
template <typename OdometryFrameType, typename KinematicType>
void EnhancedMobileBaseController<OdometryFrameType,KinematicType>::
imu_callback_(const sensor_msgs::Imu::ConstPtr & msg)
{
...
//-----------------------------------------------------------------------------
template <typename OdometryFrameType, typename KinematicType>
bool EnhancedMobileBaseController<OdometryFrameType,KinematicType>::
...
template <typename OdometryFrameType, typename KinematicType>
void EnhancedMobileBaseController<OdometryFrameType,KinematicType>::
initImuSubscriber_(ros::NodeHandle & controller_nh)
{
   imu_sub_=controller_nh.subscribe<sensor_msgs::Imu>("imu/data",1,&EnhancedMobileBaseController::imu_callback_,this);
}

//-----------------------------------------------------------------------------
template <typename OdometryFrameType, typename KinematicType>
void EnhancedMobileBaseController<OdometryFrameType,KinematicType>::
initPID_(ros::NodeHandle &controller_nh)
{
...
//    ROS_INFO_STREAM_NAMED(this->name_, "times " << time <<" "<<this->current_command_.stamp <<" "<< this->previous_command_.stamp);
...
PLUGINLIB_EXPORT_CLASS(romea::EnhancedMobileBaseController4WD, controller_interface::ControllerBase);
PLUGINLIB_EXPORT_CLASS(romea::EnhancedMobileBaseController2WD, controller_interface::ControllerBase);

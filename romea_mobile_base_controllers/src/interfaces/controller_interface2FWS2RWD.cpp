...
//-----------------------------------------------------------------------------
ControllerInterface2FWS2RWD::ControllerInterface2FWS2RWD(
  const core::MobileBaseInfo2FWS2RWD & mobile_base_info)
: rear_wheel_radius_(mobile_base_info.geometry.rearAxle.wheels.radius)
{
}

//-----------------------------------------------------------------------------
void ControllerInterface2FWS2RWD::write(
  const core::OdometryFrame2FWS2RWD & command,
  LoanedCommandInterfaces & loaned_command_interfaces) const
{
  ...
  loaned_command_interfaces[REAR_LEFT_WHEEL_SPINNING_JOINT_ID].set_value(
    command.rearLeftWheelLinearSpeed / rear_wheel_radius_);
  loaned_command_interfaces[REAR_RIGHT_WHEEL_SPINNING_JOINT_ID].set_value(
    command.rearRightWheelLinearSpeed / rear_wheel_radius_);
}

//-----------------------------------------------------------------------------
void ControllerInterface2FWS2RWD::read(
  const LoanedStateInterfaces & loaned_state_interfaces,
  core::OdometryFrame2FWS2RWD & measurement) const
{

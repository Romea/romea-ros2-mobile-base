...
ControllerInterface2AS4WD(const MobileBaseInfo2AS4WD & mobile_base_info,
  ...
  rear_steering_joint_(joints_names[REAR_AXLE_STEERING_JOINT_ID]),
...
//-----------------------------------------------------------------------------
void ControllerInterface2AS4WD::register_loaned_command_interfaces(LoanedCommandInterfaces & loaned_command_interfaces)
{
  front_steering_joint_.register_command_interface(
        loaned_command_interfaces[FRONT_AXLE_STEERING_JOINT_ID]);
  rear_steering_joint_.register_command_interface(
...
//-----------------------------------------------------------------------------
void ControllerInterface2AS4WD::register_loaned_state_interfaces(LoanedStateInterfaces & loaned_state_interfaces)
{
  front_steering_joint_.register_state_interface(
        loaned_state_interfaces[FRONT_AXLE_STEERING_JOINT_ID]);
  rear_steering_joint_.register_state_interface(
        loaned_state_interfaces[REAR_AXLE_STEERING_JOINT_ID]);
...
//-----------------------------------------------------------------------------
void ControllerInterface2AS4WD::set_command(const OdometryFrame2AS4WD &command)
{
  front_steering_joint_.set_command(command.frontAxleSteeringAngle);
  rear_steering_joint_.set_command(command.rearAxleSteeringAngle);
...
//-----------------------------------------------------------------------------
OdometryFrame2AS4WD ControllerInterface2AS4WD::get_odometry_frame() const
{
  OdometryFrame2AS4WD odometry;
  odometry.frontAxleSteeringAngle = front_steering_joint_.get_measurement();
  odometry.rearAxleSteeringAngle = rear_steering_joint_.get_measurement();
...
//-----------------------------------------------------------------------------
std::vector<std::string> ControllerInterface2AS4WD::get_command_interface_names()const
{
  return { front_steering_joint_.get_command_interface_name(),
        rear_steering_joint_.get_command_interface_name(),
...
//-----------------------------------------------------------------------------
std::vector<std::string> ControllerInterface2AS4WD::get_state_interface_names()const
{
  return { front_steering_joint_.get_state_interface_name(),
        rear_steering_joint_.get_state_interface_name(),

...
ControllerInterface1FAS2FWD::ControllerInterface1FAS2FWD(
  const core::MobileBaseInfo1FAS2FWD & mobile_base_info)
  ...
  LoanedCommandInterfaces & loaned_command_interfaces) const
{
  ...
  loaned_command_interfaces[FRONT_LEFT_WHEEL_SPINNING_JOINT_ID].set_value(
    command.frontLeftWheelLinearSpeed / front_wheel_radius_);
  loaned_command_interfaces[FRONT_RIGHT_WHEEL_SPINNING_JOINT_ID].set_value(
    command.frontRightWheelLinearSpeed / front_wheel_radius_);
}
  ...
  core::OdometryFrame1FAS2FWD & measurement) const
{
  ...
  measurement.frontLeftWheelLinearSpeed =
    front_wheel_radius_ * loaned_state_interfaces[FRONT_LEFT_WHEEL_SPINNING_JOINT_ID].get_value();
  measurement.frontRightWheelLinearSpeed =
    front_wheel_radius_ * loaned_state_interfaces[FRONT_RIGHT_WHEEL_SPINNING_JOINT_ID].get_value();
}

...
protected:
  ...
  void SetUp() override
  {
    ...
    no.arguments({
      "--ros-args",
      "-p",
      "joints.left_wheel_spinning_joint_name:=J1",
      "-p",
      "joints.right_wheel_spinning_joint_name:=J2",
    });
...
TEST_F(TestControllerInterface2WD, checkHardwareInterfaceNames)
{
  auto hardware_interface_names =
    romea::ros2::ControllerInterface2WD::hardware_interface_names(joints_names);

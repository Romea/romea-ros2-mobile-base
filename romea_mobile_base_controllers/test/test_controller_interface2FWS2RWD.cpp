...
protected:
  ...
  void SetUp() override
  {
    ...
    controller_interface = std::make_unique<romea::ControllerInterface2FWS2RWD>(mobile_info,joints_names);
...
TEST_F(TestControllerInterface2FWS2RWD, checkStateInterfaceNames)
{
...
TEST_F(TestControllerInterface2FWS2RWD, checkCommandInterfaceNames)
{

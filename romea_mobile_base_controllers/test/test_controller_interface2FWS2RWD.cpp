...
protected:
  ...
  void SetUp() override
  {
    ...
    node = std::make_shared<rclcpp::Node>("test_interface_controller_2FWS2RWD", no);
...
{
  auto hardware_interface_names = romea::ControllerInterface2FWS2RWD::hardware_interface_names(joints_names);

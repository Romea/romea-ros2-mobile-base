...
protected:
  ...
  void SetUp() override
  {
    ...
    node = std::make_shared<romea::HardwareInterfaceNode>("test_interface_controller_1FAS2FWD", no);
...
{
  auto hardware_interface_names = romea::ControllerInterface1FAS2FWD::hardware_interface_names(
    joints_names);

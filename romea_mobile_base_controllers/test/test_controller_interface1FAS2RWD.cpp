...
protected:
  ...
  void SetUp() override
  {
    ...
    controller_interface = std::make_unique<romea::ControllerInterface1FAS2RWD>(mobile_info,joints_names);
...
TEST_F(TestControllerInterface1FAS2RWD, checkCommandInterfaceNames)
{
...
TEST_F(TestControllerInterface1FAS2RWD, checkSetCommand)
{
...
TEST_F(TestControllerInterface1FAS2RWD, checkGetMeasurement)
{
  state_values[0]=11;
  state_values[1]=6;
  state_values[2]=8;

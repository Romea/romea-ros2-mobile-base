...
protected:
  ...
  void SetUp() override
  {
    ...
    no.arguments(
      {"--ros-args",
       "-p",
       "joints.front_left_wheel_spinning_joint_name:=J1",
       "-p",
       "joints.front_right_wheel_spinning_joint_name:=J2",
       "-p",
...
TEST_F(TestControllerInterface4WD, checkHardwareInterfaceNames)
{
  auto hardware_interface_names =
    romea::ros2::ControllerInterface4WD::hardware_interface_names(joints_names);

...
TEST_F(TestSimulationInterface2FWS2RWD, checkGetState)
{
  ...
  EXPECT_NEAR(state_interfaces[3].get_value(),command.rearLeftWheelSpinningSetPoint,0.001);
  EXPECT_NEAR(state_interfaces[6].get_value(),command.rearRightWheelSpinningSetPoint,0.001);
  EXPECT_NEAR(state_interfaces[9].get_value(),simulation_command.frontLeftWheelSpinningSetPoint,0.001);
  EXPECT_NEAR(state_interfaces[12].get_value(),simulation_command.frontRightWheelSpinningSetPoint,0.001);
}

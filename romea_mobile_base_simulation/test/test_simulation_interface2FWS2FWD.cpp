...
TEST_F(TestSimulationInterface2FWS2FWD, checkGetState)
{
  ...
  EXPECT_NEAR(state_interfaces[9].get_value(),simulation_command.rearLeftWheelSpinningSetPoint,0.001);
  EXPECT_NEAR(state_interfaces[12].get_value(),simulation_command.rearRightWheelSpinningSetPoint,0.001);
}

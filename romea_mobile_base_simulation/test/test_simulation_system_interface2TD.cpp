...
protected:
  ...
  void SetUp() override
  {
    std::string xacro_file =
      std::string(TEST_DIR) + "/test_simulation_system_interface2TD.xacro";
    ...
    interface = std::make_unique<romea::ros2::SimulationInterface2TD>(
      romea::ros2::SimulationInterface2TD::Configuration(info[0], "mobile_base"));
  }

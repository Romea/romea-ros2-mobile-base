...
//-----------------------------------------------------------------------------
SimulationInterface2FWS2FWD::Configuration::Configuration(
...
//-----------------------------------------------------------------------------
SimulationInterface2FWS2FWD::SimulationInterface2FWS2FWD(const Configuration & configuration)
...
std::vector<hardware_interface::ComponentInfo> get_gazebo_joint_infos(
  const SimulationInterface2FWS2FWD::Configuration & configuration)
{
  return {

...
//-----------------------------------------------------------------------------
SimulationInterface1FAS2RWD::Configuration::Configuration(
...
//-----------------------------------------------------------------------------
SimulationInterface1FAS2RWD::SimulationInterface1FAS2RWD(const Configuration & configuration)
...
std::vector<hardware_interface::ComponentInfo> get_gazebo_joint_infos(
  const SimulationInterface1FAS2RWD::Configuration & configuration)
{
  return {
...
{
  auto hardware_state = toHardwareState1FAS2RWD(wheelbase_, front_track_, simulation_state);

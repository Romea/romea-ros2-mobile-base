...
: SimulationInterface2TTD(
    [&]() {
      ...
      configuration.roller_wheel_radius = get_roller_wheel_radius(hardware_info);
...
//-----------------------------------------------------------------------------
SimulationInterface2TTD::Configuration::Configuration(
...
: left_sprocket_wheel_spinning_joint_info(
  ...
  front_left_roller_wheel_spinning_joint_info(
    get_joint_info(
      hardware_info, parameters_prefix, "front_left_roller_wheel_spinning_joint_name")),
  ...
  rear_left_roller_wheel_spinning_joint_info(
    get_joint_info(
      hardware_info, parameters_prefix, "rear_left_roller_wheel_spinning_joint_name")),
  rear_right_roller_wheel_spinning_joint_info(
    get_joint_info(
      hardware_info, parameters_prefix, "rear_right_roller_wheel_spinning_joint_name")),
...
//-----------------------------------------------------------------------------
SimulationInterface2TTD::SimulationInterface2TTD(const Configuration & configuration)

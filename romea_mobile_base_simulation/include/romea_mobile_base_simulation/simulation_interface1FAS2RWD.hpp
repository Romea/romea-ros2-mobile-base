...
class SimulationInterface1FAS2RWD final : public SimulationInterfaceBase
{
public:
  ...
  SimulationInterface1FAS2RWD(const Configuration & configuration);

  core::SimulationCommand1FAS2RWD get_hardware_command();

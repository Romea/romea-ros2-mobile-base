...
const char front_wheels_steering_control_param_name[] = "front_wheels_steering_control";
  ...
  const std::string & parameters_ns)
{
  ...
  declare_steering_angle_control_info(
    node,
    full_param_name(parameters_ns, front_wheels_steering_control_param_name));

...
const std::string rear_right_idler_wheel_spinning_joint_param_name="rear_right_idler_wheel_spinning_joint_name";
                                 ...
                                 const std::string & parameters_ns)
{
  ...
  declare_parameter<std::string>(node,parameters_ns,rear_right_idler_wheel_spinning_joint_param_name);
}
                                                          ...
                                                          const std::string & parameters_ns)
{
  ...
  insert_parameter_to_map(node,parameters_ns,rear_right_idler_wheel_spinning_joint_param_name,joint_mappings);

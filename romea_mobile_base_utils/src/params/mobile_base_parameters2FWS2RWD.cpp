...
const std::string rear_wheels_speed_control_param_name = "rear_wheels_speed_control";
                                       ...
                                       const std::string & parameters_ns)
{
  ...
  declare_wheel_speed_control_info(node,full_param_name(parameters_ns,rear_wheels_speed_control_param_name));
...
MobileBaseInfo2FWS2RWD get_mobile_base_info_2FWS2RWD(std::shared_ptr<rclcpp::Node> node,
                                                     const std::string & parameters_ns)
{
  return{get_two_wheeled_axles_info(node,full_param_name(parameters_ns,geometry_param_name)),
         ...
         get_wheel_speed_control_info(node,full_param_name(parameters_ns,rear_wheels_speed_control_param_name)),

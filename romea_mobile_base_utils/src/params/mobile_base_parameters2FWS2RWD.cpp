                                       ...
                                       const std::string & parameters_ns)
{
  ...
  declare_steering_angle_control_info(
        node,full_param_name(parameters_ns,front_wheels_steering_control_param_name));
                                   ...
                                   MobileBaseInfo2FWS2RWD & mobile_base_info)
{
  ...
  get_steering_angle_control_info(
        node,full_param_name(parameters_ns,front_wheels_steering_control_param_name),
        mobile_base_info.frontWheelsSteeringControl);

  get_wheel_speed_control_info(
        node,full_param_name(parameters_ns,rear_wheels_speed_control_param_name),
        mobile_base_info.rearWheelsSpeedControl);

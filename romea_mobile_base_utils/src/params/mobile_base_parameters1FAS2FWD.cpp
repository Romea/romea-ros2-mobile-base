...
const char front_wheels_speed_control_param_name[] = "front_wheels_speed_control";
  ...
  const std::string & parameters_ns)
{
  ...
  declare_wheel_speed_control_info(
    node,
    full_param_name(parameters_ns, front_wheels_speed_control_param_name));
...
// //-----------------------------------------------------------------------------
// void declare_joint_mappings_1FAS2FWD(
//   std::shared_ptr<rclcpp::Node> node,
//   const std::string & parameters_ns)
// {
//   declare_parameter<std::string>(
//     node, parameters_ns, front_axle_steering_joint_param_name);
//   declare_parameter<std::string>(
//     node, parameters_ns, front_left_wheel_steering_joint_param_name);
//   declare_parameter<std::string>(
//     node, parameters_ns, front_right_wheel_steering_joint_param_name);
//   declare_parameter<std::string>(
//     node, parameters_ns, front_left_wheel_spinning_joint_param_name);
//   declare_parameter<std::string>(
//     node, parameters_ns, front_right_wheel_spinning_joint_param_name);
//   declare_parameter<std::string>(
//     node, parameters_ns, rear_left_wheel_spinning_joint_param_name);
//   declare_parameter<std::string>(
//     node, parameters_ns, rear_right_wheel_spinning_joint_param_name);

// }

// //-----------------------------------------------------------------------------
// std::map<std::string, std::string> get_joint_mappings_1FAS2FWD(
//   std::shared_ptr<rclcpp::Node> node,
//   const std::string & parameters_ns)
// {
//   std::map<std::string, std::string> joint_mappings;
//   insert_parameter_to_map(
//     node, parameters_ns, front_axle_steering_joint_param_name,
//     joint_mappings);
//   insert_parameter_to_map(
//     node, parameters_ns, front_left_wheel_steering_joint_param_name,

...
//-----------------------------------------------------------------------------
hardware_interface::ComponentInfo HardwareInfo2FWSxxx::get_front_left_wheel_steering_joint_info(
...
//-----------------------------------------------------------------------------
hardware_interface::ComponentInfo HardwareInfo2FWSxxx::get_front_left_wheel_spinning_joint_info(
  const hardware_interface::HardwareInfo & hardware_info)
{
...
//-----------------------------------------------------------------------------
hardware_interface::ComponentInfo HardwareInfo2FWSxxx::get_front_right_wheel_spinning_joint_info(
  const hardware_interface::HardwareInfo & hardware_info)
{
...
//-----------------------------------------------------------------------------
hardware_interface::ComponentInfo HardwareInfo2FWSxxx::get_rear_left_wheel_spinning_joint_info(
  const hardware_interface::HardwareInfo & hardware_info)
{
...
//-----------------------------------------------------------------------------
hardware_interface::ComponentInfo HardwareInfo2FWSxxx::get_rear_right_wheel_spinning_joint_info(
  const hardware_interface::HardwareInfo & hardware_info)
{

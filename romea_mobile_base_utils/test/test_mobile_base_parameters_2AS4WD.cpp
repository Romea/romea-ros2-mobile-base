  ...
  void SetUp() override
  {
    ...
    no.arguments(
      {"--ros-args", "--params-file",
        std::string(TEST_DIR) + "/test_mobile_base_parameters_2AS4WD.yaml"});
...
{
  romea::ros2::declare_mobile_base_info_2AS4WD(node, "base");
  auto base_info = romea::ros2::get_mobile_base_info_2AS4WD(node, "base");

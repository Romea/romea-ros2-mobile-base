...
#include "romea_mobile_base_utils/params/mobile_base_parameters2FWC2RWD.hpp"

class TestMobileBaseParams2FWC2RWD : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    ...
    no.arguments(
      {"--ros-args",
       "--params-file",
       std::string(TEST_DIR) + "/test_mobile_base_parameters_2FWC2RWD.yaml"});
    node = std::make_shared<rclcpp::Node>("test_mobile_base_parameters_2FWC2RWD", no);
  }

  std::shared_ptr<rclcpp::Node> node;
};

TEST_F(TestMobileBaseParams2FWC2RWD, checkGetInfo)
{
  romea::ros2::declare_mobile_base_info_2FWC2RWD(node, "base");
  auto base_info = romea::ros2::get_mobile_base_info_2FWC2RWD(node, "base");
...
TEST_F(TestMobileBaseParams2FWC2RWD, checkGetInfoUsingGenericHelpers)
{
  romea::ros2::declare_mobile_base_info<romea::core::MobileBaseInfo2FWC2RWD>(node, "base");
  auto base_info =
    romea::ros2::get_mobile_base_info<romea::core::MobileBaseInfo2FWC2RWD>(node, "base");

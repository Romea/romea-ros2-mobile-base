...
{
  loadYaml("/home/jeanlaneurit/dev/romea_ros2/src/interfaces/sensors/romea_odo/romea_mobile_base_utils/test/data/4WD_params.yaml");
...
{
  loadYaml("/home/jeanlaneurit/dev/romea_ros2/src/interfaces/sensors/romea_odo/romea_mobile_base_utils/test/data/4WS4WD_params.yaml");
...
TEST_F(TestKinematicParams, load2WS4WDtoTwoWheelSteeringKinematicParams) {
  loadYaml("/home/jeanlaneurit/dev/romea_ros2/src/interfaces/sensors/romea_odo/romea_mobile_base_utils/test/data/2FWS4WD_params.yaml");

  ...
  void SetUp() override
  {
    ...
    no.arguments(
      {"--ros-args", "--params-file",
        std::string(TEST_DIR) + "/test_mobile_base_parameters_2FWS2RWD.yaml"});
...
{
  romea::ros2::declare_mobile_base_info_2FWS2RWD(node, "base");
  auto base_info = romea::ros2::get_mobile_base_info_2FWS2RWD(node, "base");

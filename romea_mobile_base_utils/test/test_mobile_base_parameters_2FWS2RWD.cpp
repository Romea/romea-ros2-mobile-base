...
//romea
#include "romea_mobile_base_utils/params/mobile_base_parameters2FWS2RWD.hpp"


class TestMobileBaseParams2FWS2RWD : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    ...
    no.arguments({"--ros-args","--params-file",std::string(TEST_DIR)+"/test_mobile_base_parameters_2FWS2RWD.yaml"});
    node = std::make_shared<rclcpp::Node>("test_mobile_base_parameters_2FWS2RWD", no);
  }
...
TEST_F(TestMobileBaseParams2FWS2RWD, checkGetInfo)
{
  romea::declare_mobile_base_info_2FWS2RWD(node,"base");
  auto base_info =romea::get_mobile_base_info_2FWS2RWD(node,"base");
...
//TEST_F(TestMobileBaseParams2FWS2RWD, checkGetJointMappings)
//{
//  romea::declare_joint_mappings_2FWS2RWD(node,"base.joints");
//  auto base_info =romea::get_joint_mappings_2FWS2RWD(node,"base.joints");
//}

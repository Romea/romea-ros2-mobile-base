...
protected:
  ...
  void SetUp() override
  {
    ...
    no.arguments(
      {"--ros-args",
       "--params-file",
       std::string(TEST_DIR) + "/test_mobile_base_parameters_1FAS2FWD.yaml"});
...
{
  romea::ros2::declare_mobile_base_info_1FAS2FWD(node, "base");
  auto base_info = romea::ros2::get_mobile_base_info_1FAS2FWD(node, "base");

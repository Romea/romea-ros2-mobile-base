#ifndef ROMEA_MOBILE_BASE_UTILS_CONTROL_COMMAND_PUBLISHER_HPP_
#define ROMEA_MOBILE_BASE_UTILS_CONTROL_COMMAND_PUBLISHER_HPP_
...
struct CommandPublisher <SkidSteeringCommand>
{
                                           ...
                                           const std::string & message_type)
  {
    if (message_type == "geometry_msgs/Twist")
    {
      ...
      throw std::runtime_error("Output message type "+ message_type +
...
#endif  // ROMEA_MOBILE_BASE_UTILS_CONTROL_COMMAND_PUBLISHER_HPP_

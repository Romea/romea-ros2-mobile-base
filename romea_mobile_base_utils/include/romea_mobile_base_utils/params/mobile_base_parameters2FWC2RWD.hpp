...
#ifndef ROMEA_MOBILE_BASE_UTILS__PARAMS__MOBILE_BASE_PARAMETERS2FWC2RWD_HPP_
#define ROMEA_MOBILE_BASE_UTILS__PARAMS__MOBILE_BASE_PARAMETERS2FWC2RWD_HPP_
...
// romea
#include "romea_core_mobile_base/info/MobileBaseInfo2FWC2RWD.hpp"
...
void declare_mobile_base_info_2FWC2RWD(
  std::shared_ptr<Node> node, const std::string & parameters_ns)
{
  ...
  declare_wheel_speed_control_info(
    node, full_param_name(parameters_ns, "rear_wheels_speed_control"));
...
template<typename Node>
core::MobileBaseInfo2FWC2RWD get_mobile_base_info_2FWC2RWD(
  std::shared_ptr<Node> node, const std::string & parameters_ns)
{
  return {
    get_two_wheeled_axles_info(node, full_param_name(parameters_ns, "geometry")),
    get_wheel_speed_control_info(node, full_param_name(parameters_ns, "rear_wheels_speed_control")),
...
#endif  // ROMEA_MOBILE_BASE_UTILS__PARAMS__MOBILE_BASE_PARAMETERS2FWC2RWD_HPP_

...
#ifndef ROMEA_MOBILE_BASE_UTILS__ROS2_CONTROL__HARDWARE__SWIVELING_JOINT_HARDWARE_INTERFACE_HPP_
#define ROMEA_MOBILE_BASE_UTILS__ROS2_CONTROL__HARDWARE__SWIVELING_JOINT_HARDWARE_INTERFACE_HPP_
...
class SwivelingJointHardwareInterface
{
public:
  using Feedback = HardwareStateInterface;

public:
  explicit SwivelingJointHardwareInterface(const hardware_interface::ComponentInfo & joint_info);

  SwivelingJointHardwareInterface(
...
#endif  // ROMEA_MOBILE_BASE_UTILS__ROS2_CONTROL__HARDWARE__SWIVELING_JOINT_HARDWARE_INTERFACE_HPP_

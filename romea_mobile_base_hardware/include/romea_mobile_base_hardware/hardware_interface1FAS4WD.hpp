...
class HardwareInterface1FAS4WD final : public HardwareInterfaceBase
{
public:
  ...
  enum JointIds
  {
    ...
    FRONT_LEFT_WHEEL_SPINNING_JOINT_ID = 1,
    FRONT_RIGHT_WHEEL_SPINNING_JOINT_ID = 2,
    REAR_LEFT_WHEEL_SPINNING_JOINT_ID = 3,
    REAR_RIGHT_WHEEL_SPINNING_JOINT_ID = 4
  };
  ...
  HardwareInterface1FAS4WD(const Configuration & configuration);
...
private:
  void complete_feedback_(const core::HardwareState1FAS4WD & hardware_state);

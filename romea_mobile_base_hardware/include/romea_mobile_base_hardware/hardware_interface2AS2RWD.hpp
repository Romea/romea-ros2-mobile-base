#ifndef _romea_HardwareInterface2AS2RWD_hpp_
#define _romea_HardwareInterface2AS2RWD_hpp_
...
public:
  ...
  HardwareInterface2AS2RWD(const hardware_interface::HardwareInfo & hardware_info,

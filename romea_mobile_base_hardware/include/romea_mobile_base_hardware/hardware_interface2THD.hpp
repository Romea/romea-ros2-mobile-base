...
struct HardwareInterface2THD{
  ...
  SpinningJointHardwareInterface front_left_idler_wheel_spinning_joint;
  SpinningJointHardwareInterface front_right_idler_wheel_spinning_joint;
  SpinningJointHardwareInterface rear_left_idler_wheel_spinning_joint;
  SpinningJointHardwareInterface rear_right_idler_wheel_spinning_joint;

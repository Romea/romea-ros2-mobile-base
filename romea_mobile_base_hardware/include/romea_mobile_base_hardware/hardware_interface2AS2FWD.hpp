#ifndef _romea_HardwareInterface2AS2FWD_hpp_
#define _romea_HardwareInterface2AS2FWD_hpp_
...
public:
  ...
  HardwareInterface2AS2FWD(const hardware_interface::HardwareInfo & hardware_info,

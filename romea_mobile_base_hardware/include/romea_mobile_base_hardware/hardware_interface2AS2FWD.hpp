...
#ifndef ROMEA_MOBILE_BASE_HARDWARE__HARDWARE_INTERFACE2AS2FWD_HPP_
#define ROMEA_MOBILE_BASE_HARDWARE__HARDWARE_INTERFACE2AS2FWD_HPP_
...
class HardwareInterface2AS2FWD final : public HardwareInterfaceBase
{
public:
  ...
  HardwareInterface2AS2FWD(
    const hardware_interface::HardwareInfo & hardware_info,
    const std::string & spinning_joint_command_interface_type);

  HardwareInterface2AS2FWD(const Configuration & configuration);

  core::HardwareCommand2AS2FWD get_hardware_command() const;
  sensor_msgs::msg::JointState get_joint_state_command();

  void set_feedback(const core::HardwareState2AS2FWD & hardware_state);
...
private:
  void complete_feedback_(const core::HardwareState2AS2FWD & hardware_state);
...
#endif  // ROMEA_MOBILE_BASE_HARDWARE__HARDWARE_INTERFACE2AS2FWD_HPP_

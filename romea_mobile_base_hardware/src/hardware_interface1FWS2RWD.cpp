...
HardwareInterface1FWS2RWD::HardwareInterface1FWS2RWD(const hardware_interface::HardwareInfo & hardware_info,
  ...
  front_wheel_steering_joint_(hardware_info.joints[FRONT_WHEEL_STEERING_JOINT_ID]),
  ...
  front_wheel_spinning_joint_feedback_(hardware_info.joints[FRONT_WHEEL_SPINNING_JOINT_ID])
{
...
HardwareInterface1FWS2RWD::export_state_interfaces()
{
  ...
  front_wheel_steering_joint_.export_state_interface(state_interfaces);
  ...
  front_wheel_spinning_joint_feedback_.export_state_interfaces(state_interfaces);
...
HardwareInterface1FWS2RWD::export_command_interfaces()
{
  ...
  front_wheel_steering_joint_.export_command_interface(command_interfaces);
...
//-----------------------------------------------------------------------------
HardwareCommand1FWS2RWD HardwareInterface1FWS2RWD::get_command()const
{
  return {front_wheel_steering_joint_.get_command(),
        rear_left_wheel_spinning_joint_.get_command(),
        rear_right_wheel_spinning_joint_.get_command()};
}

//-----------------------------------------------------------------------------
void HardwareInterface1FWS2RWD::set_state(const HardwareState1FWS2RWD & hardware_state)
{
  front_wheel_steering_joint_.
      set_state(hardware_state.frontWheelSteeringAngle);
                                          ...
                                          const RotationalMotionState & front_wheel_set_point)
{
  ...
  front_wheel_spinning_joint_feedback_.set_state(front_wheel_set_point);

...
//-----------------------------------------------------------------------------
HardwareInterface2AS4WD::Configuration::Configuration(
...
//-----------------------------------------------------------------------------
HardwareInterface2AS4WD::HardwareInterface2AS4WD(const Configuration & configuration)
: front_axle_steering_joint_(
...
//-----------------------------------------------------------------------------
core::HardwareCommand2AS4WD HardwareInterface2AS4WD::get_hardware_command() const
{
  // *INDENT-OFF*
  return {
...
//-----------------------------------------------------------------------------
void HardwareInterface2AS4WD::set_feedback(const core::HardwareState2AS4WD & hardware_state)
{
...
//-----------------------------------------------------------------------------
void HardwareInterface2AS4WD::set_feedback(const sensor_msgs::msg::JointState & joint_states)
{
  ...
  // core::HardwareState2AS4WD hardware_state = {
...
//-----------------------------------------------------------------------------
void HardwareInterface2AS4WD::complete_feedback_(const core::HardwareState2AS4WD & hardware_state)
{
  core::SimulationState2AS4WD simulation_state =
    toSimulationState2AS4WD(wheelbase_, front_track_, rear_track_, hardware_state);

...
HardwareInterface2TTD::HardwareInterface2TTD(
  ...
  front_left_roller_wheel_spinning_joint_feedback_(hardware_info.joints[FRONT_LEFT_ROLLER_WHEEL_SPINNING_JOINT_ID]),
  front_right_roller_wheel_spinning_joint_feedback_(hardware_info.joints[FRONT_RIGHT_ROLLER_WHEEL_SPINNING_JOINT_ID]),
  rear_left_roller_wheel_spinning_joint_feedback_(hardware_info.joints[REAR_LEFT_ROLLER_WHEEL_SPINNING_JOINT_ID]),
  rear_right_roller_wheel_spinning_joint_feedback_(hardware_info.joints[REAR_RIGHT_ROLLER_WHEEL_SPINNING_JOINT_ID])

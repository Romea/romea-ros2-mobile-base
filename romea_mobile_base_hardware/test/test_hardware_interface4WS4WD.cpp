...
protected:
  ...
  void SetUp() override
  {
    ...
    std::string urdf_file =  std::string(TEST_DIR)+"/test_hardware_interface4WS4WD.urdf";
...
TEST_F(TestHarwareInterface4WS4WD, checkJointNames)
{
...
TEST_F(TestHarwareInterface4WS4WD, checkCommandInterfaceTypeWhenEffortControlIsUsed)
{

...
class TestHardwareSystemInterface2TD : public ::testing::Test
{
protected:
  void SetUp() override
  {
    hardware_infos = parse_hardware_info("test_hardware_system_interface2TD.xacro");
...
TEST_F(
  TestHardwareSystemInterface2TD,
  checkFactoryCreatesInterfaceFromPrefixedParameters)
{
  auto hardware_interface =
    romea::ros2::make_hardware_interface(hardware_infos[0], "2TD", "mobile_base");

  auto & interface = dynamic_cast<romea::ros2::HardwareInterface2TD &>(*hardware_interface);

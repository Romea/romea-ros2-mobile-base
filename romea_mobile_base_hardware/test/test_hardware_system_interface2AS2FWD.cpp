...
class TestHardwareSystemInterface2AS2FWD : public ::testing::Test
{
protected:
  void SetUp() override
  {
    hardware_infos = parse_hardware_info("test_hardware_system_interface2AS2FWD.xacro");
...
TEST_F(
  TestHardwareSystemInterface2AS2FWD,
  checkFactoryCreatesInterfaceFromPrefixedParameters)
{
  auto hardware_interface =
    romea::ros2::make_hardware_interface(hardware_infos[0], "2AS2FWD", "mobile_base");

  auto & interface = dynamic_cast<romea::ros2::HardwareInterface2AS2FWD &>(*hardware_interface);
  ...
  checkSystemInterfaceLoadsDynamicInterface)
{
  ...
  auto & interface =
    system_interface.hardware_interface<romea::ros2::HardwareInterface2AS2FWD>("mobile_base");
  ...
  checkSystemInterfaceExportsStateAndCommandInterfaces)
{
  ...
  expect_interface_name(state_interfaces[12], "rear_left_wheel_spinning_joint/position");
  expect_interface_name(state_interfaces[15], "rear_right_wheel_spinning_joint/position");
  ...
  checkCoreHardwareStateValuesAreExportedIntoStateInterfaces)
{
  ...
  romea::core::HardwareState2AS2FWD state;

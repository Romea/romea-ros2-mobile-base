...
class TestHardwareSystemInterface2FWS2RWD : public ::testing::Test
{
protected:
  void SetUp() override
  {
    hardware_infos = parse_hardware_info("test_hardware_system_interface2FWS2RWD.xacro");
...
TEST_F(
  TestHardwareSystemInterface2FWS2RWD,
  checkFactoryCreatesInterfaceFromPrefixedParameters)
{
  auto hardware_interface =
    romea::ros2::make_hardware_interface(hardware_infos[0], "2FWS2RWD", "mobile_base");

  auto & interface = dynamic_cast<romea::ros2::HardwareInterface2FWS2RWD &>(*hardware_interface);
  ...
  checkSystemInterfaceLoadsDynamicInterface)
{
  ...
  auto & interface =
    system_interface.hardware_interface<romea::ros2::HardwareInterface2FWS2RWD>("mobile_base");
  ...
  checkSystemInterfaceExportsStateAndCommandInterfaces)
{
  ...
  expect_interface_name(state_interfaces[8], "front_left_wheel_spinning_joint/position");
  expect_interface_name(state_interfaces[11], "front_right_wheel_spinning_joint/position");
  ...
  checkCoreHardwareStateValuesAreExportedIntoStateInterfaces)
{
  ...
  romea::core::HardwareState2FWS2RWD state;

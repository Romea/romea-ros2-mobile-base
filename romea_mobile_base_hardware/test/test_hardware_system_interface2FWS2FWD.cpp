...
class TestHardwareSystemInterface2FWS2FWD : public ::testing::Test
{
protected:
  void SetUp() override
  {
    hardware_infos = parse_hardware_info("test_hardware_system_interface2FWS2FWD.xacro");
...
TEST_F(
  TestHardwareSystemInterface2FWS2FWD,
  checkFactoryCreatesInterfaceFromPrefixedParameters)
{
  auto hardware_interface =
    romea::ros2::make_hardware_interface(hardware_infos[0], "2FWS2FWD", "mobile_base");

  auto & interface = dynamic_cast<romea::ros2::HardwareInterface2FWS2FWD &>(*hardware_interface);
  ...
  checkCoreHardwareStateValuesAreExportedIntoStateInterfaces)
{
  ...
  romea::core::HardwareState2FWS2FWD state;

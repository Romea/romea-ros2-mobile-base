...
class TestHardwareSystemInterface2AS4WD : public ::testing::Test
{
protected:
  void SetUp() override
  {
    hardware_infos = parse_hardware_info("test_hardware_system_interface2AS4WD.xacro");
...
TEST_F(
  TestHardwareSystemInterface2AS4WD,
  checkFactoryCreatesInterfaceFromPrefixedParameters)
{
  auto hardware_interface =
    romea::ros2::make_hardware_interface(hardware_infos[0], "2AS4WD", "mobile_base");

  auto & interface = dynamic_cast<romea::ros2::HardwareInterface2AS4WD &>(*hardware_interface);

  auto joint_names = interface.get_joint_names();
  ASSERT_EQ(joint_names.size(), 6u);
  EXPECT_EQ(joint_names[0], "front_axle_steering_joint");
  EXPECT_EQ(joint_names[1], "rear_axle_steering_joint");
  EXPECT_EQ(joint_names[2], "front_left_wheel_spinning_joint");
  EXPECT_EQ(joint_names[3], "front_right_wheel_spinning_joint");
  EXPECT_EQ(joint_names[4], "rear_left_wheel_spinning_joint");
  EXPECT_EQ(joint_names[5], "rear_right_wheel_spinning_joint");
}
  ...
  checkSystemInterfaceExportsStateAndCommandInterfaces)
{
  ...
  expect_interface_name(state_interfaces[2], "front_left_wheel_spinning_joint/position");
  expect_interface_name(state_interfaces[5], "front_right_wheel_spinning_joint/position");
  expect_interface_name(state_interfaces[8], "rear_left_wheel_spinning_joint/position");
  expect_interface_name(state_interfaces[11], "rear_right_wheel_spinning_joint/position");
  expect_interface_name(state_interfaces[14], "front_left_wheel_steering_joint/position");
  expect_interface_name(state_interfaces[15], "front_right_wheel_steering_joint/position");
  expect_interface_name(state_interfaces[16], "rear_left_wheel_steering_joint/position");
  expect_interface_name(state_interfaces[17], "rear_right_wheel_steering_joint/position");
  ...
  expect_interface_name(command_interfaces[2], "front_left_wheel_spinning_joint/velocity");
  expect_interface_name(command_interfaces[3], "front_right_wheel_spinning_joint/velocity");
  expect_interface_name(command_interfaces[4], "rear_left_wheel_spinning_joint/velocity");
  expect_interface_name(command_interfaces[5], "rear_right_wheel_spinning_joint/velocity");
}
  ...
  checkCommandValuesArePackedIntoJointState)
{
  ...
  EXPECT_EQ(command.name[2], "front_left_wheel_spinning_joint");
  EXPECT_EQ(command.name[3], "front_right_wheel_spinning_joint");
  EXPECT_EQ(command.name[4], "rear_left_wheel_spinning_joint");
  EXPECT_EQ(command.name[5], "rear_right_wheel_spinning_joint");
  ...
  checkJointStateFeedbackValuesAreExportedIntoStateInterfaces)
{
  ...
  feedback.name[2] = "front_left_wheel_spinning_joint";
  feedback.name[3] = "front_right_wheel_spinning_joint";
  feedback.name[4] = "rear_left_wheel_spinning_joint";
  feedback.name[5] = "rear_right_wheel_spinning_joint";
  ...
  checkCoreHardwareStateValuesAreExportedIntoStateInterfaces)
{
  ...
  romea::core::HardwareState2AS4WD state;
  state.frontAxleSteeringAngle = 1.0;
  state.rearAxleSteeringAngle = 2.0;
  state.frontLeftWheelSpinningMotion.position = 3.0;
  state.frontLeftWheelSpinningMotion.velocity = 4.0;
  state.frontLeftWheelSpinningMotion.torque = 5.0;
  state.frontRightWheelSpinningMotion.position = 6.0;
  state.frontRightWheelSpinningMotion.velocity = 7.0;
  state.frontRightWheelSpinningMotion.torque = 8.0;
  state.rearLeftWheelSpinningMotion.position = 9.0;
  state.rearLeftWheelSpinningMotion.velocity = 10.0;
  state.rearLeftWheelSpinningMotion.torque = 11.0;
  state.rearRightWheelSpinningMotion.position = 12.0;
  state.rearRightWheelSpinningMotion.velocity = 13.0;
  state.rearRightWheelSpinningMotion.torque = 14.0;

...
TEST_F(TestHarwareInterface1FAS4WD, checkSetFeedback)
{
  MakeInterface(hardware_interface::HW_IF_VELOCITY);
...
TEST_F(TestHarwareInterface1FAS4WD, checkSetFeedbackUsingJointStates)
{
  MakeInterface(hardware_interface::HW_IF_VELOCITY);
...
TEST_F(TestHarwareInterface1FAS4WD, checkGetCommand)
{
  ...
  romea::core::HardwareCommand1FAS4WD current_command = interface->get_hardware_command();
...
TEST_F(TestHarwareInterface1FAS4WD, checkGetCommandUsingJointState)
{
  MakeInterface(hardware_interface::HW_IF_VELOCITY);
  ...
  EXPECT_EQ(command.name.size(), 5u);

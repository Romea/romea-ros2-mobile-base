...
: front_left_wheel_steering_joint_(
    parent_model, HardwareInfo4WS4WD::get_front_left_wheel_steering_joint_info(hardware_info)),
  front_right_wheel_steering_joint_(
    parent_model, HardwareInfo4WS4WD::get_front_right_wheel_steering_joint_info(hardware_info)),
  rear_left_wheel_steering_joint_(
    parent_model, HardwareInfo4WS4WD::get_rear_left_wheel_steering_joint_info(hardware_info)),
  rear_right_wheel_steering_joint_(
    parent_model, HardwareInfo4WS4WD::get_rear_right_wheel_steering_joint_info(hardware_info)),

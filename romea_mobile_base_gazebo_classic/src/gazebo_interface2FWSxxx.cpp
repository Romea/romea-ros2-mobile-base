...
: front_left_wheel_steering_joint_(
    parent_model, HardwareInfo2FWSxxx::get_front_left_wheel_steering_joint_info(hardware_info)),
  front_right_wheel_steering_joint_(
    parent_model, HardwareInfo2FWSxxx::get_front_right_wheel_steering_joint_info(hardware_info)),

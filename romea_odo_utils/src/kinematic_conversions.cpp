//romea-ros
#include "romea_odo_utils/kinematic_conversions.hpp"
...
//-----------------------------------------------------------------------------
KinematicMeasure to_romea(const romea_odo_msgs::msg::KinematicMeasure & msg)
{
...
void to_ros_msg(const KinematicMeasure & romea_kinematic_measure,
              romea_odo_msgs::msg::KinematicMeasure  & ros_kinematic_msg)
{
  ...
  std::copy(romea_kinematic_measure.covariance.data(),
...
void to_ros_msg(const rclcpp::Time & stamp,
              ...
              romea_odo_msgs::msg::KinematicMeasureStamped & ros_kinematic_stamped_msg)
{
...
//-----------------------------------------------------------------------------
OneAxleSteeringMeasure to_romea(const romea_odo_msgs::msg::OneAxleSteeringMeasure & msg)
{
...
void to_ros_msg(const OneAxleSteeringMeasure & romea_one_axle_steering_measure,
              romea_odo_msgs::msg::OneAxleSteeringMeasure  & ros_one_axle_steering_measure_msg)
{
  ros_one_axle_steering_measure_msg.longitudinal_speed = romea_one_axle_steering_measure.longitudinalSpeed;
  ros_one_axle_steering_measure_msg.steering_angle = romea_one_axle_steering_measure.steeringAngle;

  std::copy(ros_one_axle_steering_measure_msg.covariance.data(),
...
void to_ros_msg(const rclcpp::Time & stamp,
              ...
              romea_odo_msgs::msg::OneAxleSteeringMeasureStamped & ros_one_axle_steering_measure_msg)
{
...
//-----------------------------------------------------------------------------
TwoAxleSteeringMeasure to_romea(const romea_odo_msgs::msg::TwoAxleSteeringMeasure & msg)
{
...
void to_ros_msg(const TwoAxleSteeringMeasure & romea_two_axle_steering_measure,
              romea_odo_msgs::msg::TwoAxleSteeringMeasure  & ros_two_axle_steering_measure_msg)
{
  ros_two_axle_steering_measure_msg.longitudinal_speed = romea_two_axle_steering_measure.longitudinalSpeed;
  ros_two_axle_steering_measure_msg.front_steering_angle = romea_two_axle_steering_measure.frontSteeringAngle;
  ros_two_axle_steering_measure_msg.rear_steering_angle = romea_two_axle_steering_measure.rearSteeringAngle;

  std::copy(ros_two_axle_steering_measure_msg.covariance.data(),
...
void to_ros_msg(const rclcpp::Time & stamp,
              ...
              romea_odo_msgs::msg::TwoAxleSteeringMeasureStamped &ros_two_axle_steering_measure_msg)
{
...
//-----------------------------------------------------------------------------
SkidSteeringMeasure to_romea(const romea_odo_msgs::msg::SkidSteeringMeasure & msg)
{
...
//-----------------------------------------------------------------------------
OmniSteeringMeasure to_romea(const romea_odo_msgs::msg::OmniSteeringMeasure & msg)
{
...
void to_ros_msg(const OmniSteeringMeasure & romea_omni_steering_measure,
              romea_odo_msgs::msg::OmniSteeringMeasure  & ros_omni_steering_measure_msg)
{
  ...
  std::copy(ros_omni_steering_measure_msg.covariance.data(),
...
void to_ros_msg(const rclcpp::Time & stamp,
              ...
              romea_odo_msgs::msg::OmniSteeringMeasureStamped & ros_omni_steering_measure_msg)
{
...
void to_ros_msg(const SkidSteeringMeasure & romea_skid_steering_measure,
              romea_odo_msgs::msg::SkidSteeringMeasure  & ros_skid_steering_measure_msg)
{
  ...
  std::copy(ros_skid_steering_measure_msg.covariance.data(),
...
void to_ros_msg(const rclcpp::Time & stamp,
              ...
              romea_odo_msgs::msg::SkidSteeringMeasureStamped & ros_skid_steering_measure_msg)
{

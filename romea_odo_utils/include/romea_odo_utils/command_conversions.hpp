...
void to_ros_msg(const romea::TwoAxleSteeringCommand & romea_two_axle_steering_command,
                romea_odo_msgs::msg::TwoAxleSteeringCommand & ros_two_axle_steering_command_msg);

void to_romea(const romea_odo_msgs::msg::TwoAxleSteeringCommand & ros_two_axle_steering_command_msg,
             romea::TwoAxleSteeringCommand & romea_two_axle_steering_command);

void to_ros_msg(const romea::OneAxleSteeringCommand & romea_one_axle_steering_command,
                romea_odo_msgs::msg::OneAxleSteeringCommand & ros_oxe_axle_steering_command_msg);

void to_romea(const romea_odo_msgs::msg::OneAxleSteeringCommand & ros_one_axle_steering_command_msg,
             romea::OneAxleSteeringCommand & romea_one_axle_steering_command);

void to_ros_msg(const romea::SkidSteeringCommand & romea_skid_steering_command,
                romea_odo_msgs::msg::SkidSteeringCommand & romea_skid_steering_command_msg );

void to_romea(const romea_odo_msgs::msg::SkidSteeringCommand & ros_skid_steering_command_msg,
...
void to_ros_msg(const romea::OmniSteeringCommand & romea_omni_steering_command,
                romea_odo_msgs::msg::OmniSteeringCommand & romea_omni_steering_command_msg );

void to_romea(const romea_odo_msgs::msg::OmniSteeringCommand & ros_omni_steering_command_msg,

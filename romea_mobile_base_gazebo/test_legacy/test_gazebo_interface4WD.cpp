...
{
  std::string urdf = make_urdf_description("4WD");
  std::string world = create_sdf_world_file("4WD");

  TestGazeboInterfaceFixture<romea::ros2::GazeboInterface4WD> fixture(world, urdf);
  fixture.Simulator();

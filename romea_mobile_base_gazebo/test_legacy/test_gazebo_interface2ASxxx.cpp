...
TEST(TestGazeboInterface2ASxxx, testSetGet2AS4WD)
{
  ...
  EXPECT_NEAR(command.rearAxleSteeringAngle, state.rearAxleSteeringAngle, 0.1);
  EXPECT_NEAR(command.frontLeftWheelSteeringAngle, state.frontLeftWheelSteeringAngle, 0.12);
  EXPECT_NEAR(command.frontRightWheelSteeringAngle, state.frontRightWheelSteeringAngle, 0.12);
  EXPECT_NEAR(command.rearLeftWheelSteeringAngle, state.rearLeftWheelSteeringAngle, 0.12);
  EXPECT_NEAR(command.rearRightWheelSteeringAngle, state.rearRightWheelSteeringAngle, 0.12);
  EXPECT_NEAR(

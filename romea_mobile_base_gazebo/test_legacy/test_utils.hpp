...
#ifndef ROMEA_MOBILE_BASE_GAZEBO__TEST_LEGACY__TEST_UTILS_HPP_
#define ROMEA_MOBILE_BASE_GAZEBO__TEST_LEGACY__TEST_UTILS_HPP_
...
{
  return std::string(TEST_DIR) + "/gz_empty.sdf";
}
...
std::string create_sdf_world_file(const std::string & vehicle_type)
{
  create_sdf_file(vehicle_type);
...
#endif  // ROMEA_MOBILE_BASE_GAZEBO__TEST_LEGACY__TEST_UTILS_HPP_

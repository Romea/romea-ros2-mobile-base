...
public:
  TestGazeboInterfaceFixture(
    ...
    const std::string & _robotUrdfDescription)
    : fixture(_worldPath),
      urdf(_robotUrdfDescription)
  {
  }
      ...
      this->fixture
          .OnConfigure(
                  ...
                  gz::sim::EventManager &_eventManager)
              {
                ...
                auto physicsComponent = _ecm.Component<gz::sim::components::Physics>(world.Entity()); // NOLINT
...
protected:
  virtual void OnConfigure(
      ...
      gz::sim::EventManager &)
  {
    auto robotJoinEntities = _ecm.ChildrenByComponents(
      *_ecm.EntityByName("robot"), gz::sim::components::Joint());

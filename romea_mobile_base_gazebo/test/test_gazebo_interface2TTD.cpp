...
TEST(TestGazeboInterface2TTD, testSetGet)
{
  ...
  EXPECT_NEAR(
    command.frontLeftRollerWheelSpinningSetPoint, state.frontLeftRollerWheelSpinningMotion.velocity, 0.1); // NOLINT
  EXPECT_NEAR(
    command.frontRightRollerWheelSpinningSetPoint, state.frontRightRollerWheelSpinningMotion.velocity, 0.1); // NOLINT
  EXPECT_NEAR(
    command.rearLeftRollerWheelSpinningSetPoint, state.rearLeftRollerWheelSpinningMotion.velocity, 0.1); // NOLINT
  EXPECT_NEAR(
    command.rearRightRollerWheelSpinningSetPoint, state.rearRightRollerWheelSpinningMotion.velocity, 0.1); // NOLINT
}

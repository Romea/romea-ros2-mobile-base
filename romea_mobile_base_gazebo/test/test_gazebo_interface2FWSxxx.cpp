...
TEST(TestGazeboInterface2FWSxxx, testSetGet2FWS2RWD)
{
  std::string urdf = make_urdf_description("2FWSxxx", "2FWS2RWD");
  std::string world = create_sdf_world_file("2FWS2RWD");

  TestGazeboInterfaceFixture<romea::ros2::GazeboInterface2FWSxxx> fixture(world, urdf);
  fixture.Simulator();
...
TEST(TestGazeboInterface2FWSxxx, testSetGet2FWS2FWD)
{
  std::string urdf = make_urdf_description("2FWSxxx", "2FWS2FWD");
  std::string world = create_sdf_world_file("2FWS2FWD");
...
TEST(TestGazeboInterface2FWSxxx, testSetGet2FWS4WD)
{
  std::string urdf = make_urdf_description("2FWSxxx", "2FWS4WD");
  std::string world = create_sdf_world_file("2FWS4WD");

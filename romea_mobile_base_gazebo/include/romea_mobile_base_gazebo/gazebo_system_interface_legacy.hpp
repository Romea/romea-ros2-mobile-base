...
#ifndef ROMEA_MOBILE_BASE_GAZEBO__GAZEBO_SYSTEM_INTERFACE_LEGACY_HPP_
#define ROMEA_MOBILE_BASE_GAZEBO__GAZEBO_SYSTEM_INTERFACE_LEGACY_HPP_
...
class GazeboSystemInterfaceLegacy : public gz_ros2_control::GazeboSimSystemInterface
{
public:
  using CallbackReturn = rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn;

public:
  GazeboSystemInterfaceLegacy();
...
using GazeboSystemInterface1FAS2FWD =
  GazeboSystemInterfaceLegacy<GazeboInterface1FASxxx, SimulationInterface1FAS2FWD>;
using GazeboSystemInterface1FAS2RWD =
  GazeboSystemInterfaceLegacy<GazeboInterface1FASxxx, SimulationInterface1FAS2RWD>;
using GazeboSystemInterface2AS4WD =
  GazeboSystemInterfaceLegacy<GazeboInterface2ASxxx, SimulationInterface2AS4WD>;
using GazeboSystemInterface2FWS2FWD =
  GazeboSystemInterfaceLegacy<GazeboInterface2FWSxxx, SimulationInterface2FWS2FWD>;
using GazeboSystemInterface2FWS2RWD =
  GazeboSystemInterfaceLegacy<GazeboInterface2FWSxxx, SimulationInterface2FWS2RWD>;
using GazeboSystemInterface2FWS4WD =
  GazeboSystemInterfaceLegacy<GazeboInterface2FWSxxx, SimulationInterface2FWS4WD>;
using GazeboSystemInterface2TD =
  GazeboSystemInterfaceLegacy<GazeboInterface2TD, SimulationInterface2TD>;
using GazeboSystemInterface2THD =
  GazeboSystemInterfaceLegacy<GazeboInterface2THD, SimulationInterface2THD>;
using GazeboSystemInterface2TTD =
  GazeboSystemInterfaceLegacy<GazeboInterface2TTD, SimulationInterface2TTD>;
using GazeboSystemInterface2WD =
  GazeboSystemInterfaceLegacy<GazeboInterface2WD, SimulationInterface2WD>;
using GazeboSystemInterface4WD =
  GazeboSystemInterfaceLegacy<GazeboInterface4WD, SimulationInterface4WD>;
using GazeboSystemInterface4WS4WD =
  GazeboSystemInterfaceLegacy<GazeboInterface4WS4WD, SimulationInterface4WS4WD>;

}  // namespace ros2
}  // namespace romea

#endif  // ROMEA_MOBILE_BASE_GAZEBO__GAZEBO_SYSTEM_INTERFACE_LEGACY_HPP_

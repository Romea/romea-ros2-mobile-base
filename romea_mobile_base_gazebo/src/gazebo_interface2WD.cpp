...
GazeboInterface2WD::GazeboInterface2WD(gazebo::physics::ModelPtr parent_model,
  ...
  left_wheel_spinning_joint_(parent_model,hardware_info.joints[HardwareInterface2WD::LEFT_WHEEL_SPINNING_JOINT_ID],command_interface_type),
  right_wheel_spinning_joint_(parent_model,hardware_info.joints[HardwareInterface2WD::RIGHT_WHEEL_SPINNING_JOINT_ID],command_interface_type)
{

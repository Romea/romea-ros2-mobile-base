...
#include "romea_mobile_base_gazebo/gz_system.hpp"
...
class romea::ros2::GazeboSimSystemPrivate
{
public:
...
PLUGINLIB_EXPORT_CLASS(
  romea::ros2::GazeboSimSystem, gz_ros2_control::GazeboSimSystemInterface)

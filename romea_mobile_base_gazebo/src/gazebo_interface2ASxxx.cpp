...
: front_axle_steering_joint_(
    ecm, enable_joints, HardwareInfo2ASxxx::get_front_axle_steering_joint_info(hardware_info)),
  rear_axle_steering_joint_(
    ecm, enable_joints, HardwareInfo2ASxxx::get_rear_axle_steering_joint_info(hardware_info)),
  ...
  rear_left_wheel_steering_joint_(
    ecm, enable_joints, HardwareInfo2ASxxx::get_rear_left_wheel_steering_joint_info(hardware_info)),
...
{
  return {
    front_axle_steering_joint_.get_state(),
